  ...
  return (
    <div className="min-h-screen bg-[#F0F2F5]">
      ...
      <div className="max-w-screen-2xl mx-auto pt-16 ">
        ...
        <div className="hidden lg:block lg:w-72 fixed top-16 left-0 h-[calc(100vh-64px)] p-4">
          <LeftSide />
        </div>

        {/* Main Content */}
        <main className="flex-grow lg:ml-72 lg:mr-72 pt-5 md:mx-2 md:px-4">
          {children}
        </main>

        {/* Right Sidebar - Fixed for large screens */}
        <div className="hidden lg:block lg:w-72 fixed top-16 right-0 h-[calc(100vh-64px)] p-4">
          <RightSide />
        </div>
      </div>
