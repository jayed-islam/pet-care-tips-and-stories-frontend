    ...
    <div className="relative overflow-hidden   transition-transform duration-300 transform z-10">
      ...
      <div className="absolute bottom-0 left-0 p-5">
        ...
        <div className="w-full">
          <Link href={`${paths.post.root}/${post._id}`}>
            <h2 className="text-2xl md:text-3xl font-bold text-white line-clamp-2 overflow-ellipsis mt-3 hover:underline transition-all duration-300">
              {firstElementText}
            </h2>
          </Link>
          <Link
